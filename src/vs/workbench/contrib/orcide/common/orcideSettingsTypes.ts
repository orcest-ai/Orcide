...
import { OrcideSettingsState } from './orcideSettingsService.js'
...
export type OrcideStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
type CommonProviderSettings = {
	...
	models: OrcideStatefulModelInfo[],
}
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: OrcideStatefulModelInfo[] } => {
	return {
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: OrcideSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: OrcideSettingsState) => {
